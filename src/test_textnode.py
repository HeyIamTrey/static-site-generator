...
class TestTextNode(unittest.TestCase):
    ...
    def test_text(self):
        ...
        self.assertEqual(html_node.value, "<i>This is a text node</i>")

    def test_text(self):
        node = TextNode("This is a text node", TextType.CODE)
        html_node = text_node_to_html_node(node)
        self.assertEqual(html_node.tag, "code")
        self.assertEqual(html_node.value, "<code>This is a text node</code>")

    def test_text(self):
        node = TextNode("This is a text node", TextType.LINK, "https://www.google.com")
        html_node = text_node_to_html_node(node)
        self.assertEqual(html_node.tag, "a")
        self.assertEqual(html_node.value, '<a href="https://www.google.com">This is a text node</a>')
